   ...
   @else
       ...
       @endif
        ...
        @if (empty($m__users_id))
            <h2> 最初にプロファイルを作成してください <a href="/" style="color:blue !important; margin-top: 28px !important"> ここをクリック </a>
            </h2> <br />
        @else

            <a href="{{ url('/mypage') }}"><img style="border-radius: 50%" class="refBtn mr-2"
                    src="{{ asset('storage/mypage/ref-blue.png') }}" alt=""></a>
    ...
    color: #ffd00d;;">{{ number_format(($steps * $get_m_user_stride) / 100000, 1, '.', '') }}km / {{ $total }}km</p>
            ...
            <div class="container pt-3 pb-3">
                <div class="row justify-content-between w-75 mx-auto p-0"
                    style="border-radius: 20px; border: solid 1px #2b63c6;">
                    <div class="col-10">
                        <a href="/createtour">
                            <p class="p-1 my-auto" style="font-size: 12px; color: #2b63c6">ツアーの一覧や変更はこちら</p>
                        </a>
                    </div>
            ...
            <div class="container">
                ...
                <p class="w-100 text-center pt-0 mt-0"><img class="mt-0 pt-0" src="{{ asset('storage/mypage/lineUp.png') }}"
                        alt=""></p>
            </div>
            @if ($today_data >= $get_m_user_daily_goal)
                <div class="container"
                    ...
                    <div class="relative w-100 h-50"
                        style="background: url({{ asset('storage/padometerscreen/graphcomp.png') }}); background-size: 52% 104%; background-position: center; background-repeat: no-repeat">
                    ...
                    <div class="container-fluid w-75 pb-3">
                        <div class="speech-bubble2 text-center">
                            <p class="mb-0 font-weight-bold" style="font-size:90%; color:#113A83;">あと
                                {{ $current_month_steps }}歩 {{ ($current_month_steps * $get_m_user_stride) / 100000 }}
                                で目標達成！</p>
                        </div>
                    </div>
                ...
                <div class="container pt-3"
                    ...
                    <div id="compStar" class="">
                        ...
                        <div class="container-fluid pt-3 w-75 d-md-none">
                            <p class="text-center"
                                style="background: white; color:#ff9327; border: 2px solid #ff9327; border-radius: 15px;">
                                今日までの累計 {{ $current_month_steps }}歩
          ...
          <div class="container d-none d-lg-block">
            <div class="row justify-content-center">
              ...
              <div class="col-sm-3">
                    ...
                    <div id="paraCont" class="">
                        <div id="paraRight" class="d-flex flex-row justify-content-end pr-3">
                            <p class="font-weight-bold p-1"
                                ...
                                残ります @if ($get_m_user_monthly_goal <= $current_month_steps)
                                    0
                                @else {{ $get_m_user_monthly_goal - $current_month_steps }}歩
                        ...
                        <div id="paraLeft" class="d-flex flex-row justify-content-start mt-3">
                            <p class="font-weight-bold p-1"
                                ...
                                あと {{ $current_month_steps }}歩 {{ ($current_month_steps * $get_m_user_stride) / 100000 }}
                                Km!</p>
                        </div>
                    </div>
                    ...
                    <connection from="#paraLeft" to="#triCont" color="#2b63c6" fromX="0.5" fromY="0" toX="0.16" toY="0.41">
                    </connection>
                    <connection from="#paraRight" to="#triCont" color="#cecece" fromX="0.4" fromY="0" toX="0.725"
                        toY="0.15"></connection>
                </div>
            @endif
            <div class="container-fluid navfix" style="background-color: #2b63c6;">
                <div class="row d-flex text-center">
                    <div class="col-3 padding-0 pt-2 navItem is-active" style="border-right: 2px solid #113a83;" id="box1"
                        ...
                        <a href='/mypage'>
                            ...
                            <p id="box1_title" class="pt-0 mt-0"
                                style="font-size: 60%; font-weight: bold;text-align: center;color: #fddb66;">マイページ</p>
                        </a>
                    </div>
                    <div class="col-3 padding-0 pt-2 navItem" style="border-right: 2px solid #113a83;" id="box2"
                        ...
                        <a href='/mycollection'>
                            ...
                            <p id="box2_title" class="pt-0 mt-0"
                                style="font-size: 60%; font-weight: normal;text-align: center;color: #ffffff;">コレクション</p>
                        </a>
                    </div>
                    ...
                    <div class="col-3 padding-0 pt-2 navItem" id="box4" onclick="navItemClick(this.id);">
                        <a href="/showprofiledetails">
                            ...
                            <p id="box4_title" class="pt-0 mt-0"
                                style="font-size: 60%; font-weight: normal;text-align: center;color: #ffffff;">設定</p>
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    checkpoints.forEach((item, i) => {
                        ...
                        if (item["prefectures"]) {
                            if (i == checkpoints.length - 1) {
                                div_textRight_p.className =
                                    "py-0 my-0 pl-3 text-xs-left text-sm-center dd pb-0 mb-0 ";
                                div_textRight_p.innerHTML = '<img  class = "pt-1 pb-0 mb-0" src="{{ URL::asset('
                                storage / mypage / flag.png ') }}" alt="flag"/>' + item["prefectures"].substring(0,
                                    5);
                            } else {
                            ...
                            if (tr_count_id > 1) {
                                ...
                                if (i == checkpoints.length - 1) {
                                    ...
                                    var con_html = '<connection from="' + id_from + '" to="' + id_to +
                                        '" color="#cadcf6" fromX="0.6" fromY="1.2" toX="0.6" toY="0.1"></connection>';
                                } else {
                                    var con_html = '<connection from="' + id_from + '" to="' + id_to +
                                        '" color="#cadcf6" fromX="0.6" fromY="1.2" toX="0.6" toY="0.1" tail></connection>';
                                }
