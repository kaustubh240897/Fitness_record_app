...
<div class='container-fluid' style="margin-top:0px">
					 ...
					 <div class='c mx-2 my-2 fixed-top' style='z-index:100 !important; margin-top:0px'><img  style='border: solid  #2b63c6;' src="{{ asset($my_collections->m_collections->path .'icon/'. $my_collections->m_collections->filename) }}" class= "rounded-circle mt-3" alt="Cinque Terre" width="
					 	80" height="80">
					 </div>
             ...
             @if($my_collections->m_collections->collection_category == 'tour')
					 		<p class='ml-3 mt-3 color'><img class='mr-1' src='/storage/img/complete.png'>{{ $my_collections->m_collections->m__tours->title_abbreviation }} </p>
            ...
            @else
            <p class='ml-3 mt-3 color'>{{ $my_collections->m_collections->m__checkpoints->tours->title_abbreviation }} </p>
