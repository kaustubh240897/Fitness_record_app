...
@section('content')
    ...
    <body>
        @if (!empty($my_collections))
            <div class='container-fluid' style="margin-top:28px">
                ...
                <div class="row d-flex fixed-top" style=" z-index:0; background-color: #2b63c6; position:fixed; top:28px">
                    ...
                    <div class='col-10 p-2 mx-3' style="color:white;">
                        @if ($my_collections->m_collections->collection_category == 'tour')
                        <span class="badge badge-pill badge-warning ml-2 mr-1">ツアー</span> @else <img class='mx-2'
                                src="/storage/img/label-1.png"> @endif
                        {{ $my_collections->m_collections->collection_title }}
                    </div>

                </div>

                <div class='c mx-2 my-2 fixed-top' style='z-index:0; margin-top:28px'><img style='border: solid  #2b63c6;'
                        src="{{ asset($my_collections->m_collections->path . $my_collections->m_collections->filename) }}"
                        class="rounded-circle mt-3" alt="Cinque Terre" width="
         80" height="80">
                </div>
                ...
                <div class='row fixed-top' style='position:relative;'>
                    <div class='col-12 wrapper'>
                        @if ($my_collections->m_collections->collection_category == 'tour')
                            <p class='ml-3 mt-3 color'><img class='mr-1'
                                    src='/storage/img/complete.png'>{{ $my_collections->m_collections->m__tours->tour_title }}
                            </p>
                            <p class='color'> <span class="badge badge-pill badge-warning ml-2 mr-1">ツアー</span>
                                {{ $my_collections->m_collections->collection_title }} </p>
                            <div class='row d-flex wrapper1'>
                                <div class='col p-2 ml-5'> <img class='mr-2 mb-2' src='/storage/img/ico.png'>
                                    <font style='color:#ffcc00;'>430 Km </font>
                                </div>
                                <div class='col p-2 c' style='color:white;'><span class="fa fa-star checked mx-1 "></span>
                                    {{ $my_collections->m_collections->updated_at->format('Y/m/d') }} </div>
                            </div>
                        @else
                            <p class='ml-3 mt-3 color'>
                                {{ $my_collections->m_collections->m__checkpoints->tours->tour_title }} </p>
                            <p class='color'> <img class='ml-3' src='/storage/img/label-1.png'>
                                {{ $my_collections->m_collections->collection_title }} </p>
                            <div class='c' style='color:white;'><span
                                    class="fa fa-star checked mx-1"></span>{{ $my_collections->m_collections->updated_at->format('Y/m/d') }}
                            </div>
                        @endif
        ...
        <div class='container-fluid' style='background-color: #f2f2f2; bottom: 66px;'>
            ...
            <b> <text class='hr my-1'>
                    @if ($my_collections->m_collections->collection_category == 'tour')
                    {{ $my_collections->m_collections->m__tours->tour_comment }} @else
                        {{ $my_collections->m_collections->m__checkpoints->comments }} @endif
                </text></b>
            ...
            @if ($my_collections->m_collections->collection_category == 'tour')
                ...
                <script type="text/javascript">
                    ...
                    if ({
                            !!json_encode($my_collections - > m_collections - > collection_category) !!
                        } == 'checkpoint') {
                        prog_id = "progress_bar_col";
                        console.log("checkpoint");
                        var title = {
                            !!json_encode($my_collections - > m_collections - > m__tours - > tour_title) !!
                        };
                        console.log(title);
                        if (!value) {
                            checkpoints = {
                        ...
                        checkpoints.forEach((item, i) => {
                            ...
                            if (i == 0) {
                                if (item["distance"] < dist_walked) {
                                    ...
                                    if (flag1 == 1) {
                                        ...
                                        var div_sp_li_p = document.createElement("p");
                                        div_sp_li_p.className =
                                        "py-0 speech-bubble pl-2 pr-1 w-100 pb-1 text-break";
                                        div_sp_li_p.style.fontSize = "80%";
                                        div_sp_li_p.innerHTML = item["checkpoint_title"];
                                        div_sp_li.appendChild(div_sp_li_p);
                                        div_sp.appendChild(div_sp_li);
                            ...
                            if (item["prefectures"]) {
                                if (i == checkpoints.length - 1) {
                                    ...
                                    storage / mypage / flag.png ') }}" alt="flag"/>' + item["prefectures"]
                                        .substring(0, 5);;
                                } else {
                        ...
                        checkpoints.forEach((item, i) => {
                            ...
                            if (item["prefectures"]) {
                                if (i == checkpoints.length - 1) {
                                    ...
                                    div_textRight_p.innerHTML = '<img  class = "pt-1" src="{{ URL::asset('
                                    storage / mypage / flag.png ') }}" alt="flag"/>' + item["prefectures"]
                                        .substring(0, 5);;
                                } else {
                                    div_textRight_p.innerHTML = item["prefectures"];
            ...
            @else
                ...
                <script type="text/javascript">
                    ...
                    if ({
                        ...
                        console.log("checkpoint");
                        var title = {
                            !!json_encode($my_collections - > m_collections - > m__checkpoints - > checkpoint_title) !!
                        };
                        console.log(title);
                        if (!value) {
                            checkpoints = {
