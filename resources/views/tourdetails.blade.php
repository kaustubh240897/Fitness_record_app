...
@section('content')
    ...
    <body style='background-color: #f2f2f2'>
        <div class="fixed-top">
            ...
            <div class=" row flex-row" style=" z-index:0; background-color: #2b63c6;">
                ...
                <div class='col-12 '> <img class='mx-2 mb-2' src='/storage/img/ico.png'>
                    <font style='color:#ffcc00;'>{{ $total }} Km </font>
                </div>
    ...
    @endif -->
        <div class='container-fluid' style='background-color: #f2f2f2; margin-top: 28px'>
            ...
            <div class='row'>
                <div class='col-12 text-center my-3' style='margin-bottom:25% !important;'><a href='/createtour'>
                        <p class="mb-4  text-center" style="border: solid 1px #2b63c6; border-radius: 15px;">
                            < リストに戻る</p>
                    </a></div>
                <div class='col-12 text-center'>
                    <form action="{{ route('tourstore', $tours->id) }}" method="POST">
                        ...
                        <div class="d-flex flex-row justify-content-center my-2">
                            <button type='button' class="button1 w-100 refBtn text-center " data-toggle="modal"
                                data-target="#exampleModalCenter">
                                < このツアーを選択してください </button>
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" style='color:#2b63c6;' id="exampleModalLongTitle">
                                            ツアーの方向を選択してください</h5>
                                    ...
                                    <div class="modal-body">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        ...
                                                        @if ($value == 'false')
                                                            <input class="form-check-input" type="radio" name="gridRadios"
                                                                id="gridRadios2" value="3" checked>
                                                        @else
                                                            <input class="form-check-input" type="radio" name="gridRadios"
                                                                id="gridRadios2" value="3">
                                                        @endif

                                                        <label class="form-check-label" style='color:#2b63c6;'
                                                            for="inlineRadio1">通常の踏破</label>
                                                    </div>
                                                    <!-- </div> -->
                                                    <br>
                                                    <!-- <div class="col"> -->
                                                    <div class="form-check form-check-inline">
                                                        @if ($value == 'true')
                                                            <input class="form-check-input ml-3" type="radio"
                                                                name="gridRadios" id="gridRadios2" value="4" checked>
                                                        @else
                                                            <input class="form-check-input ml-3" type="radio"
                                                                name="gridRadios" id="gridRadios2" value="4">
                                                        @endif
                                                        <label class="form-check-label" style='color:#2b63c6;'
                                                            for="inlineRadio2">逆方向に踏破</label>
                                                    </div>
                                                </div>

                                            </div>
                                            <hr />
                                            <img class='mr-1' style='width:100%; height:auto;'
                                                src='/storage/img/tour-change.png'>
                                            <div class='container mt-5'>


                                                @foreach ($constant_data as $c)
                                                    <div class='row py-2' style='background-color: #fdf2e3;'>
                                                        <div class='col-1'> <img class='mr-2' src='/storage/img/point.png'>
                                                        </div>
                                                        <div class='col-10'> {{ $c }}
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <div class='row'>
                                                <div class='col-12 text-center mr-2'><button type="submit" class="button"
                                                        style='background-color:#2b63c6 ; color:white'>ツアーの変更</button></div>

                                                <div class='col-12 text-center mr-2'><button type="button"
                                                        class='button mt-2' style='background-color:white;'
            ...
            checkpoints.forEach((item, i) => {
                ...
                if (item["prefectures"]) {
                    if (i == checkpoints.length - 1) {
                        ...
                        storage / mypage / flag.png ') }}" alt="flag"/>' + item["prefectures"].substring(0, 5);;
                    } else {
