...
@section('content')
    ...
    <div class="container-fluid sticky-top" style="margin-top: 28px">
        <div class="row d-flex justify-content-between pb-0 mb-0" style="background-color: #2B63C6; height:30px">
            <div class='col-4 shadow-lg mb-0 pb-0 mt-1 pt-1'>
                <p class="shadow-lg mb-0 pb-0" style="color:white; font-size: 80%">マイヒストリ</p>
            </div>
            <!-- <p class="text-center" style="color:white; font-size: 80%">マイヒストリ</p> -->
            <div class="col-2 mb-0 pb-0 mt-1 shadow-lg padding-0">
                <a href="{{ route('userhistory', [now()->year, now()->month]) }}"><button id="tab_monthly"
                        class="text-center not_selected_tab mb-0 pb-0" style="color: white; font-size: 80%;
                              background-color: #2b63c6;" onclick="changeTab(this.id);">月間</button></a>
            </div>
            <div class="col-2 mb-0 pb-0 mt-1 shadow-lg padding-0">

                <a href="{{ route('usermonthlyhistory', [now()->year]) }}"><button id="tab_yearly"
                        class="text-center selected_tab mb-0 pb-0" style="color: white; font-size: 80%;
            ...
            <div class='col-4 pb-0 mb-0 shadow-lg'>
               ...
               border: solid 1px #ffffff;
               background-color: #2b63c6;" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        並び替え ↑↓
                    </button>
                    <div class="dropdown-menu speech-bubble dropdown-menu-right" aria-labelledby="dropdownMenu2">
                        <a id="sort_newest" onclick="sortHistory(this.id);"> <label class="radio-inline pl-2">
                                <input id="sort_newest_radio" class="pt-3" type="radio" name="optradio"><span
                                    id="sort_newest_span" class="not_selected_sort pl-2 pb-2"
                                    style="font-size: 100%">実績の新しい順</span>
                            </label></a>
                        <a id="sort_oldest" onclick="sortHistory(this.id);"> <label class="radio-inline pl-2 pb-2">
                                <input id="sort_oldest_radio" class="pt-3" type="radio" name="optradio"><span
                                    id="sort_oldest_span" class="not_selected_sort pl-2 pb-1"
                                    style="font-size: 100%">実績の古い順</span>
                            </label> </a>
                    </div>
                </div>
            </div>
        ...
        <div id="month_list" class="row d-flex pt-2 pb-0 mb-0  invisible" style="background-color:#fff; z-index: 0">
            <div class="col-2 w-100 padding-0 mb-0">
                <p id="yearnumber" class="w-100 pl-3"
                    style="font-weight: bold; color: #2b63c6;background-color: #fff; height: 27px;">2020</p>
            </div>
            <div class="col-10 mb-0">
                <div id="monthsContainer" class="pl-3 mb-0 scrolling-wrapper row  flex-nowrap ">
                    <div class="col">
                        <button id="12" onclick="myFunc(this.id);" class="px-1 selected_month"
                            style="background-color:#fff;">12</button>
                    </div>
                    <div class="col">
                        <button id="11" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">11</button>
                    </div>
                    <div class="col">
                        <button id="10" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">10</button>
                    </div>
                    <div class="col">
                        <button id="9" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">9</button>
                    </div>
                    <div class="col">
                        <button id="8" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">8</button>
                    </div>
                    <div class="col">
                        <button id="7" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">7</button>
                    </div>
                    <div class="col">
                        <button id="6" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">6</button>
                    </div>
                    <div class="col">
                        <button id="5" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">5</button>
                    </div>
                    <div class="col">
                        <button id="4" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">4</button>
                    </div>
                    <div class="col">
                        <button id="3" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">3</button>
                    </div>
                    <div class="col">
                        <button id="2" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">2</button>
                    </div>
                    <div class="col">
                        <button id="1" onclick="myFunc(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">1</button>
                    </div>
                </div>
            </div>
        </div>
        <div id="year_list" class="row d-flex pt-1" style="background-color:#fff; z-index: 0">
            <div class="col-12 w-100">
                <div id="yearsContainer" class=" scrolling-wrapper row flex-row flex-nowrap">
                    <div class="col">
                        <button id="2020" onclick="myFunc2(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">2020</button>
                    </div>
                    <div class="col">
                        <button id="2019" onclick="myFunc2(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">2019</button>
                    </div>
                    <div class="col">
                        <button id="2018" onclick="myFunc2(this.id);" class="px-1 not_selected_month"
                            style="background-color:#fff;">2018</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div style='padding-top:0;'>
        ...
        <div class="container-fluid navfix" style="background-color: #2b63c6;">
            <div class="row d-flex text-center">
                ...
                <div class="col-3 padding-0 pt-2 navItem is-active" style="border-right: 2px solid #113a83;" id="box3"
                    onclick="navItemClick(this.id);">
                    <a href="{{ route('userhistory', [now()->year, now()->month]) }}">
                        ...
                        <p id="box3_title" class="pt-0 mt-0"
                            style="font-size: 60%; font-weight: bold;text-align: center;color: #fddb66;">マイヒストリ</p>
                    </a>
                </div>
                  ...
                  @php($perct = ($total / $get_m_user_monthly_goal) * 100)
                        ...
                        if (is_rev == 1) {
                            ...
                            Object.keys(dates).reverse().forEach((date, i) => {
                                ...
                                if (totalSteps > goal) {
                                    ...
                                    td3.innerHTML = parseInt((totalSteps / goal) * 100) +
                                        '<span style="font-size:80%">%</span> <img style="height: 15px; width: 15px;" class="pb-1" src="{{ URL::asset('
                                    storage / history / co.svg ') }}" alt="">';
                                } else {
                                    td1.innerHTML = d.getMonth() + 1;
                                    dist_km = totalSteps * {
                                        {
                    ...
                    <script type="text/javascript">
                        ...
                        function handleGesure2() {
                            if (touchendX2 - touchstartX2 < -50 && (touchendY2 - touchstartY2 < 25 && touchendY2 - touchstartY2 > -
                                25)) {
                                //alert('swiped left!');
