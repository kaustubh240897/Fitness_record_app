...
@section('content')
    ...
    .rt_pos {
      ...
      padding-bottom: 2.5% !important;
        ...
        * iPad Landscape */ @media only screen and (min-device-width: 768px) and (max-device-width: 1024px) {
    ...
    @else
        <div class="container-fluid pt-3" style="color:#FFFFFF; border-radius: 15px;">
            <div class="row justify-content-center">
                <div class="col pt-1 text-center">
                    <p class="font-weight-bold pr-3 py-2"
                        style="background: white; color:#2b63c6; border: 2px solid white; border-radius: 15px;">{{ $year }}年
                        {{ $month }}月 {{ $day }}日 火曜日</p>
                </div>
        ...
        @if (empty($get_t_tour))
            ...
            <a href="{{ url('/createtour') }}">
                <p id="btnMyPage" value="" onclick="mypage.performClick(this.value)"
                    class="myPageBtn my-0 mr-2 mb-3 text-center pt-3 text-break px-2"
                    style="color: #fff; font-size: 11px; font-weight: bold;width: 90px;height: 90px;border: solid 2px #ffffff; border-radius: 50% !important;
        ...
        background: url({{ asset('storage/padometerscreen/blue.png') }}); background-size: fill; background-position: center; background-repeat: no-repeat">
                    {{ $get_t_tour->m_tours->tour_title }}<br> 参加中！
                </p>
            </a>
        @endif
        <a href="{{ url('/padometerscreen') }}"><img style="border-radius: 50%" class="refBtn d-block d-sm-none mt-2 mr-2"
                src="{{ asset('storage/padometerscreen/ref.png') }}" alt=""></a>
        <a href="{{ url('/padometerscreen') }}"><img style="border-radius: 50%"
                class="refBtn d-none d-sm-block d-md-none mt-2 mr-2" src="{{ asset('storage/padometerscreen/ref.png') }}"
                alt=""></a>
        <a href="{{ url('/padometerscreen') }}"><img style="border-radius: 50%"
                class="refBtn d-none d-md-block d-lg-none mt-2 mr-2" src="{{ asset('storage/padometerscreen/ref.png') }}"
                alt=""></a>
        <a href="{{ url('/padometerscreen') }}"><img style="border-radius: 50%"
                class="refBtn d-none d-lg-block d-xl-none mt-2 mr-2" src="{{ asset('storage/padometerscreen/ref.png') }}"
                alt=""></a>
        <a href="{{ url('/padometerscreen') }}"><img style="border-radius: 50%" class="refBtn d-none d-xl-block mt-2 mr-2"
                src="{{ asset('storage/padometerscreen/ref.png') }}" alt=""></a>
        <div class="container-fluid pt-3">
            <div class="row">
                <div class="col-6">
                    <div class="card">
                        <a href="http://3.114.126.114:8012/recipe/serial_number"><img class="card-img-top"
                                src="{{ asset('storage/padometerscreen/rec.png') }}" alt="Card image cap"></a>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card">
                        <a href="http://3.114.126.114:8012/himekuri/specified_date/{serial_number}"><img
                                class="card-img-top" src="{{ asset('storage/padometerscreen/cal.png') }}"
        ...
        @if ($today_data >= $get_m_user_daily_goal)
            <div class="container"
                style="background: url({{ asset('storage/padometerscreen/complete01.png') }}); background-size: cover; background-position: center; background-repeat: no-repeat">
                ...
                <div id="bg_season1" class="container-fluid pt-3"
                    style="background-size: 100% 80%; background-position: right 100%;; background-repeat: no-repeat">
                    <div class="relative w-100 h-50"
                        style="background: url({{ asset('storage/padometerscreen/graphcomp.png') }}); background-position: center; background-repeat: no-repeat">
                        <canvas id="myChart"></canvas>
                        <div class="absolute-center text-center">
                            <p class="mb-0 p-0" style="font-size:70%; color:#ff9327;">
                                {{ ($today_data * $get_m_user_stride) / 100000 }} km</p>
                            ...
                            <p class="mb-0" style="font-size:70%; color: #113A83">
                                {{ ($get_m_user_daily_goal * $get_m_user_stride) / 100000 }} (km)</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="container-fluid w-75 pb-3">
                    <div class="speech-bubble2 text-center">
                        <p class="mb-0 font-weight-bold" style="font-size:90%; color:#113A83;">あと
                            {{ $current_month_steps }}歩 {{ ($current_month_steps * $get_m_user_stride) / 100000 }} で目標達成！
                        </p>
                    </div>
                </div>
                <div id="bg_season2" class="container-fluid pt-3 pb-3"
                    style="background-size: 100% 80%; background-position: right 100%;; background-repeat: no-repeat">
                    <div class="relative w-100 h-50"
                        style="background: url({{ asset('storage/padometerscreen/graph.png') }}); background-size: 52% 104%; background-position: center; background-repeat: no-repeat">
                        <canvas id="myChart"></canvas>
                        <div class="absolute-center text-center">
                            <p class="mb-0 p-0" style="font-size:70%; color:#2b63c6;">
                                {{ ($today_data * $get_m_user_stride) / 100000 }} km</p>
        ...
        @if ($current_month_steps >= $get_m_user_monthly_goal)
            <div class="container pt-3"
                ...
                <div class="container-fluid pt-3 w-75 d-md-none">
                    <p class="text-center"
                        style="background: white; color:#ff9327; border: 2px solid #ff9327; border-radius: 15px;">今日までの累計
                        {{ $current_month_steps }}歩 ({{ ($current_month_steps * $get_m_user_stride) / 100000 }} Km)</p>
                </div>
                ...
                <div class="container-fluid" style="z-index: 2000 !important;">
                    <p style="z-index: 2000 !important;" class="text-center"> <img style="z-index: 2000 !important;"
                            src="{{ asset('storage/padometerscreen/star.png') }}" alt=""> </p>
                </div>
                ...
                <div class="container-fluid overlay-tri2">
                    ...
                    <div class="container-fluid pt-3 w-25 d-none d-lg-block">
                        <p class="text-center"
                            style="background: #113A83; color:#FFFFFF; border: 2px solid #113A83; border-radius: 15px;">
                            今月の累計目標 {{ $current_month_steps }}歩 ({{ ($current_month_steps * $get_m_user_stride) / 100000 }}
                            Km)</p>
                    </div>
                    <div class="container-fluid pt-3 w-50 d-none d-md-block d-lg-none">
                        <p class="text-center"
                                ...
                                <div class="col text-left p-0 m-0">
                                    <div class="d-flex flex-row">
                                        <p class="pl-2">疑似ツアーで全国を歩こう！
                                            ウォーキングの各種設定や
                                            詳細情報の確認もこちら。</p>
                                        <p> <img class="pl-3" src="{{ asset('storage/padometerscreen/ico_arrow_r.png') }}"
                                                alt=""> </p>
                                    </div>
                                </div>
                                <div class="col-4 text-right p-0 m-0 rt_pos">
                                    <div class="float-right p-0 m-0"
                                        style="border: solid 2px #2b63c6; background-color: #2b63c6;  width: 96px;height: 100px; border-radius: 50%">
                                ...
                                <div class="col text-left p-0 m-0">
                                    <div class="d-flex flex-row">
                                        <p class="pl-2">疑似ツアーで全国を歩こう！
                                            ...
                                            詳細情報の確認もこちら。</p>
                                        <p> <img class="pl-3"
                                                src="{{ asset('storage/padometerscreen/ico_arrow_R_orange.png') }}" alt="">
                                        </p>
                                    </div>
                                </div>
                                <div class="col-4 text-right p-0 m-0 rt_pos">
            ...
            <div class="container">
                        ...
                        <div class="col col-sm-5 text-center">
                            <div class="d-flex flex-row-reverse pl-3 pb-3 mb-3 overlay-text2">
                                <div class="text-center">
                                    <p class="mb-0 pb-0 font-weight-bold pr-sm-3"
                                        style="background: #dce0e3; font-size:70%; color:#113A83; border: 2px solid #dce0e3; border-radius: 15px;">
                                    残ります @if ($get_m_user_monthly_goal <= $current_month_steps) 0 @else
                                            {{ $get_m_user_monthly_goal - $current_month_steps }}歩
                                            {{ round((($get_m_user_monthly_goal - $current_month_steps) * $get_m_user_stride) / 100000, 2) }}
                                        @endif Km!</p>
                            ...
                            <div class="d-flex flex-row pr-3">
                                <div class="text-center">
                                    <p class="mb-0 mt-0 pt-0 font-weight-bold px-1 pl-sm-2 pl-md-3"
                                        style="background: white; font-size:70%; color:#2b63c6;; border: 1px solid #2b63c6;; border-radius: 15px;">
                                        あと {{ $current_month_steps }}歩
                                        {{ ($current_month_steps * $get_m_user_stride) / 100000 }} Km!</p>
                                    <div class="row justify-content-center">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col col-sm-5 text-center">
                            ...
                            <div class="d-flex flex-row pl-3">
                                <div class="text-center">
                                    <p class="mb-0 mt-0 pt-0 font-weight-bold pl-sm-2 pl-md-3 pl-3 pl-lg-3 pr-3"
                                        style="background: white; font-size:70%; color:#2b63c6; border: 1px solid #2b63c6;; border-radius: 15px;">
                                        あと {{ $current_month_steps }}歩
                                        {{ ($current_month_steps * $get_m_user_stride) / 100000 }} Km!</p>
                                    <div class="row justify-content-center">
                ...
                <div class="container-fluid overlay-tri">
                    ...
                    <div class="container-fluid pt-3 w-25 d-none d-lg-block">
                        <p class="text-center"
                            style="background: #113A83; color:#FFFFFF; border: 2px solid #113A83; border-radius: 15px;">
                            今月の累計目標 {{ $get_m_user_monthly_goal }}歩
                            ({{ ($get_m_user_monthly_goal * $get_m_user_stride) / 100000 }} Km)</p>
                    </div>
                    <div class="container-fluid pt-3 w-50 d-none d-md-block d-lg-none">
                        <p class="text-center"
                            style="background: #113A83; color:#FFFFFF; border: 2px solid #113A83; border-radius: 15px;">
                ...
                if ({
                    ...
                    if ({
                        ...
                        if ({
                            ...
                            var rem = {
                                {
                                    $get_m_user_monthly_goal - $current_month_steps
                                }
                            };
                        } else {
                            rem = 0;
        ...
        <script type="text/javascript">
            ...
            if ({
                ...
                comp = {
                    {
                        ($today_data * $get_m_user_stride) / 100000
                    }
                };
                if ({
                        {
                        ...
                        {
                            ($get_m_user_daily_goal * $get_m_user_stride) / 100000
                        }
                    }) {
                    rem = 0;
                } else {
                    rem = {
                        {
                            ($get_m_user_daily_goal * $get_m_user_stride) / 100000 - ($today_data *
                                $get_m_user_stride) / 100000
                        }
                    };
                }
            } else {
        ...
        <script type="text/javascript">
            ...
            var current_week_datas1 = {
                !!json_encode($current_week_datas) !!
            }
                        ...
                        if (!meta.hidden) {
                            meta.data.forEach(function(segment, index) {
                                if (stepsData[index] > 0) {
                                    ...
                                    var text1 = encoded.replace(REG_HEX, function(match,
                                    group1) {
                                    ...
                                    ctx.fillText(textVertical, -chart.height + 3 * Chart
                                        .defaults.global.defaultFontSize, x + 15);
