        ...
        @if (!empty($my_checkpoint))
            <div class='container-fluid' style="margin-top: 28px;">
                ...
                <div class="row d-flex fixed-top" style=" z-index:1; background-color: #2b63c6; position: fixed; top:28px;">
                    ...
                    <div class='col-10 p-2 mx-3' style="color:white;"><img class='mx-2'
                            src='/storage/img/label-1.png'>{{ $my_checkpoint->m_collections->collection_title }}</div>
                ...
                <div class='row fixed-top' style='position: relative; z-index: 3;'>
                    <div class='col-12 wrapper'>
                        ...
                        <p class='color'> <img class='ml-3' src='/storage/img/label-1.png'>
                            {{ $my_checkpoint->m_collections->collection_title }} </p>
            ...
            <script type="text/javascript">
                ...
                if (!value) {
                    ...
                    if ({
                            !!json_encode($my_checkpoint - > m_collections - > collection_category) !!
                        } == 'checkpoint') {
                        prog_id = "progress_bar_col";
                        var title = {
                            !!json_encode($my_checkpoint - > checkpoint_title) !!
                        };
                        console.log(title);
