    ...
    <body>
        ...
        <div class="fixed-top">
            <div class="container-fluid bg-white  py-0 my-0 px-3" style="height:28px !important;">
                <div class="d-flex flex-row justify-content-between">
                    <div class="p-0">
                        <img src="{{ asset('storage/mypage/ico_back.png') }}" alt="" onclick="goBack()"
            ...
            <div class="container-fluid p-0 m-0 w-100"
                style="box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.5); background-color: #2b63c6;">
                <p class="p-2 w-100" style="color: #fff; font-size: 80%; font-weight: bold"> <span class="pl-2">設定</span>
                    <span class="pl-2">></span> <span class="pl-2">個人設定の変更</span>
                </p>
            </div>
        </div>
        <form action="{{ route('store') }}" method="POST">
            ...
            <div class="container-fluid pt-0 mt-0" style="margin-top: 70px !important">
                ...
                <p class=" text-center overlay-line1"><img src="{{ asset('storage/settings/lineUp.png') }}" alt=""
                ...
                <div class="d-flex flex-row pb-2" style="border-bottom: 3px solid rgb(248,252,253);">
                    <div class="col-4 pl-2">
                        <div class="d-flex flex-row">
                            <input id="heightinput" class="w-100" type="number" step="any" name='inputheight' value="170"
                                onchange="heightChange()" required><span class=" pl-1  "
                                style="background-color: #f2f4f6; z-index: -1;">cm</span>
                        </div>
                    </div>
                    ...
                    <p class="pl-3"><img id="h_add" src="{{ asset('storage/settings/btn_add@3x.png') }}"
                            style="height: 22px; width: 22px;" class="" alt="" onclick="setHeight(this.id)"></p>
                    <p class="pl-3"><img id="h_sub" src="{{ asset('storage/settings/btn_sub@3x.png') }}"
                            style="height: 22px; width: 22px;" class="" alt="" onclick="setHeight(this.id)"></p>
                </div>
            </div>
            <div class="container-fluid pt-3">
                ...
                <div class="d-flex flex-row pb-3 justify-content-between"
                    style="border-bottom: 3px solid rgb(248,252,253);">
                    <input id="input_gender" type="number" name="gender_input" value="0" class="d-none" required>
                    <div class="col pl-2">
                        <button id="btn_male" type="button" name="button" class="text-center w-100 gender"
                            style="height: 34px; border-color: transparent; border-radius: 5px;"
                            onclick="setGender(this.id)">男性</button>
                    </div>
                    <div class="col pr-0">
                        <button id="btn_female" type="button" name="button" class="text-center w-100 gender"
                            style="height: 34px; border-color: transparent; border-radius: 5px;"
            ...
            <div class="container-fluid pt-3 pb-3">
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <button type="button" onclick="calculateStride()" class="w-50 h-25 py-0 my-0 text-center"
                        style="background: #fff; color: #2b63c6; font-size: 80%; border-radius: 12px;border: solid 1px #2b63c6;">身長と性別から自動計算</button>
                </div>
                <div class="d-flex flex-row pb-2">
                    <!-- <input id="strideinput" type="number"  name='stridelength' value="" class="d-none"> -->
                    <div class="col-4 pl-2">
                        <div class="d-flex flex-row">
                            <input id="strideinput" class="w-100" type="number" step="any" name='stridelength' value="76.5"
                                min="45" max="85" onchange="strideChange()" required><span class=" pl-1  "
                                style="background-color: #f2f4f6; z-index: -1;">cm</span>
                        </div>
                    </div>
                    <!-- <p class="text-center" style="width: 22px; height: 22px;border-radius: 20px; border: 1px solid #2b63c6;"> <span class="pb-3">+</span> </p> -->
                    <p class="pl-3"><img id="stride_add" src="{{ asset('storage/settings/btn_add@3x.png') }}"
                            style="height: 22px; width: 22px;" class="" alt="" onclick="setStride(this.id)"></p>
                    <p class="pl-3"><img id="stride_sub" src="{{ asset('storage/settings/btn_sub@3x.png') }}"
                            style="height: 22px; width: 22px;" class="" alt="" onclick="setStride(this.id)"></p>
                </div>
                ...
                <div class="d-flex flex-row pb-2 justify-content-between">
                    <div class="col w-100 ml-0 pl-2" style="">
                        <div class="d-flex flex-row">
                            ...
                            <div class="col-4 pl-2">
                                <div class="d-flex flex-row">
                                    <input id="daily_stepsInput" class="w-100" type="number" name='dailygoal' value=""
                                        min="100" max="100000" onchange="dailyStepsChange()" required><span class=" pl-1  "
                                        style="background-color: #f2f4f6; z-index: -1;">歩</span>
                                </div>
                            </div>
                            <!-- <p class="text-center" style="width: 22px; height: 22px;border-radius: 20px; border: 1px solid #2b63c6;"> <span class="pb-3">+</span> </p> -->
                            <p class="pl-3"><img id="daily_steps_add" onclick="setDailySteps(this.id);"
                                    src="{{ asset('storage/settings/btn_add@3x.png') }}" style="height: 22px; width: 22px;"
                                    class="" alt=""></p>
                            <p class="pl-3"><img id="daily_steps_sub" onclick="setDailySteps(this.id);"
                                    src="{{ asset('storage/settings/btn_sub@3x.png') }}" style="height: 22px; width: 22px;"
                                    class="" alt=""></p>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <button type="button" onclick="copyGoal()" class="w-50 py-0 my-0 text-center mb-3"
                        style="background: #fff; color: #2b63c6; font-size: 80%; border-radius: 12px;border: solid 1px #2b63c6;">1日あたりの目標を反映</button>
                ...
                <div class="d-flex flex-row pb-2">
                    ...
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            <input id="daily_stepsInput_1" class="w-100" type="number" step="any" name='dailygoal_1'
                                value="" max="85" min="0" onchange="daily_difStepsChange()" required><span class=" pl-1  "
                                style="background-color: #f2f4f6; z-index: -1;">km</span>
                        </div>
                    </div>
                    <p class="pl-3"><img id="dailygoal_1_add" onclick="getDailygoal1(this.id)"
                            src="{{ asset('storage/settings/btn_add@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                    <p class="pl-3"><img id="dailygoal_1_sub" onclick="getDailygoal1(this.id)"
                            src="{{ asset('storage/settings/btn_sub@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                </div>
                <div class="d-flex flex-row pb-2">
                    ...
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            <input id="daily_stepsInput_2" class="w-100" type="number" step="any" name='dailygoal_2'
                                value="" max="85" min="0" onchange="daily_difStepsChange()" required><span class=" pl-1  "
                                style="background-color: #f2f4f6; z-index: -1;">km</span>
                        </div>
                    </div>
                    <p class="pl-3"><img id="dailygoal_2_add" onclick="getDailygoal2(this.id)"
                            src="{{ asset('storage/settings/btn_add@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                    <p class="pl-3"><img id="dailygoal_2_sub" onclick="getDailygoal2(this.id)"
                            src="{{ asset('storage/settings/btn_sub@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                </div>
                <div class="d-flex flex-row pb-2">
                    ...
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            <input id="daily_stepsInput_3" class="w-100" type="number" step="any" name='dailygoal_3'
                                value="" max="85" min="0" onchange="daily_difStepsChange()" required><span class=" pl-1  "
                                style="background-color: #f2f4f6; z-index: -1;">km</span>
                        </div>
                    </div>
                    <p class="pl-3"><img id="dailygoal_3_add" onclick="getDailygoal3(this.id)"
                            src="{{ asset('storage/settings/btn_add@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                    <p class="pl-3"><img id="dailygoal_3_sub" onclick="getDailygoal3(this.id)"
                            src="{{ asset('storage/settings/btn_sub@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                </div>
                <div class="d-flex flex-row pb-2">
                    ...
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            <input id="daily_stepsInput_4" class="w-100" type="number" step="any" name='dailygoal_4'
                                value="" max="85" min="0" onchange="daily_difStepsChange()" required><span class=" pl-1  "
                                style="background-color: #f2f4f6; z-index: -1;">km</span>
                        </div>
                    </div>
                    <p class="pl-3"><img id="dailygoal_4_add" onclick="getDailygoal4(this.id)"
                            src="{{ asset('storage/settings/btn_add@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                    <p class="pl-3"><img id="dailygoal_4_sub" onclick="getDailygoal4(this.id)"
                            src="{{ asset('storage/settings/btn_sub@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                </div>
                <div class="d-flex flex-row pb-2">
                    ...
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            <input id="daily_stepsInput_5" class="w-100" type="number" step="any" name='dailygoal_5'
                                value="" max="85" min="0" onchange="daily_difStepsChange()" required><span class=" pl-1  "
                                style="background-color: #f2f4f6; z-index: -1;">km</span>
                        </div>
                    </div>
                    <p class="pl-3"><img id="dailygoal_5_add" onclick="getDailygoal5(this.id)"
                            src="{{ asset('storage/settings/btn_add@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                    <p class="pl-3"><img id="dailygoal_5_sub" onclick="getDailygoal5(this.id)"
                            src="{{ asset('storage/settings/btn_sub@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                </div>
                <div class="d-flex flex-row pb-2">
                    ...
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            <input id="daily_stepsInput_6" class="w-100" type="number" step="any" name='dailygoal_6'
                                value="" max="85" min="0" onchange="daily_difStepsChange()" required><span class=" pl-1  "
                                style="background-color: #f2f4f6; z-index: -1;">km</span>
                        </div>
                    </div>
                    <p class="pl-3"><img id="dailygoal_6_add" onclick="getDailygoal6(this.id)"
                            src="{{ asset('storage/settings/btn_add@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                    <p class="pl-3"><img id="dailygoal_6_sub" onclick="getDailygoal6(this.id)"
                            src="{{ asset('storage/settings/btn_sub@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                </div>
                <div class="d-flex flex-row pb-2" style="border-bottom: 3px solid rgb(248,252,253);">
                    ...
                    <div class="col-4">
                        <div class="d-flex flex-row">
                            <input id="daily_stepsInput_7" class="w-100" type="number" step="any" name='dailygoal_7'
                                value="" max="85" min="0" onchange="daily_difStepsChange()" required><span class=" pl-1  "
                                style="background-color: #f2f4f6; z-index: -1;">km</span>
                        </div>
                    </div>
                    <p class="pl-3"><img id="dailygoal_7_add" onclick="getDailygoal7(this.id)"
                            src="{{ asset('storage/settings/btn_add@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                    <p class="pl-3"><img id="dailygoal_7_sub" onclick="getDailygoal7(this.id)"
                            src="{{ asset('storage/settings/btn_sub@3x.png') }}" style="height: 22px; width: 22px;" class=""
                            alt=""></p>
                </div>
            </div>
            <div class="container-fluid pb-3">
                <div class="d-flex flex-row justify-content-between pt-3">
                    ...
                    <p id="est_monthly_dist" class="pr-2 text-center" style="font-weight: bold; color: #2b63c6;">122.4 km
                    </p>
                </div>
                ...
                <div class="d-flex flex-row justify-content-between px-2"
                    ...
                    <div class="custom-control custom-switch">
                        <input name="motionapp" type="checkbox" class="custom-control-input" id="customSwitch1"
                            onchange="motionAppChange(this.id)">
                        <label class="custom-control-label" for="customSwitch1"> <span id="motion_app_text"
                                style="color: #2b63c6;">なし</span> </label>
                    </div>
                </div>
                <div class="d-flex flex-row justify-content-between px-2 pt-3">
                    ...
                    <div class="custom-control custom-switch">
                        <input name="motionweb" type="checkbox" class="custom-control-input" id="customSwitch2"
                            onchange="motionWebChange(this.id)">
                        <label class="custom-control-label" for="customSwitch2"> <span id="motion_web_text"
                                style="color: #2b63c6;">なし</span> </label>
                    </div>
                </div>
            </div>
            <div class="container-fluid text-center pt-3">
                <button class="w-100 py-1" type="submit" name="button" style="border: solid 1px #2b63c6; background-color: #2b63c6; border-radius: 25px;
                  font-size: 120%; font-weight: bold; color: #fff">変更内容を登録 &nbsp; <span
                        style="font-size: 100%; font-weight: normal;"> ></span> </button>
            ...
            <div class="container-fluid navfix" style="background-color: #2b63c6;">
                <div class="row d-flex text-center">
                    <div class="col-3 padding-0 pt-2 navItem" style="border-right: 2px solid #113a83;" id="box1"
                        onclick="navItemClick(this.id);">
                        <a href='/mypage'>
                            <img id="box1_img" class="pb-0 mb-0" src="{{ asset('storage/mypage/box1.png') }}" alt="">
                            <p id="box1_title" class="pt-0 mt-0"
                                style="font-size: 60%; font-weight: normal;text-align: center;color: #fff;">マイページ</p>
                        </a>
                    </div>
                    <div class="col-3 padding-0 pt-2 navItem" style="border-right: 2px solid #113a83;" id="box2"
                        onclick="navItemClick(this.id);">
                        <a href='/mycollection'>
                            <img id="box2_img" class="pb-0 mb-0" src="{{ asset('storage/mypage/box2.png') }}" alt="">
                            <p id="box2_title" class="pt-0 mt-0"
                                style="font-size: 60%; font-weight: normal;text-align: center;color: #fff;">コレクション</p>
                        </a>
                    </div>
                    <div class="col-3 padding-0 pt-2 navItem" style="border-right: 2px solid #113a83;" id="box3"
                        onclick="navItemClick(this.id);">
                        <a href="{{ route('userhistory', [now()->year, now()->month]) }}">
                            <img id="box3_img" class="pb-0 mb-0" src="{{ asset('storage/mypage/box3.png') }}" alt="">
                            <p id="box3_title" class="pt-0 mt-0"
                                style="font-size: 60%; font-weight: normal;text-align: center;color: #ffffff;">マイヒストリ</p>
                        </a>
                    </div>
                    <div class="col-3 padding-0 pt-2 navItem is-active" id="box4" onclick="navItemClick(this.id);">
                        <a href="/showprofiledetails">
                            ...
                            <p id="box4_title" class="pt-0 mt-0"
                                style="font-size: 60%; font-weight: bold;text-align: center;color: #fddb66;">設定</p>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <script type="text/javascript">
                ...
                function strideChange() {
                    if (s_input.value < 45 || s_input.value > 85) {
                        ...
                        document.getElementById("stride_error").className =
                            "box2 sb10 pl-2  flex-row justify-content-center d-flex";
                    } else {
                        document.getElementById("stride_error").className =
                            "box2 sb10 pl-2  flex-row justify-content-center d-none";
                    }
                    console.log("sc");
                }
                ...
                function dailyStepsChange() {
                    if (ds_input.value < 100 || ds_input.value > 100000) {
                        console.log("invalidStride");
                        document.getElementById("dailySteps_error").className =
                            "box2 sb11 pl-2  flex-row justify-content-center d-flex";
                    } else {
                        document.getElementById("dailySteps_error").className =
                            "box2 sb11 pl-2  flex-row justify-content-center d-none";
                    }
                    console.log("sc");
                }

                function daily_difStepsChange() {
                    var total_dist = parseFloat(ds_1.value) + parseFloat(ds_2.value) + parseFloat(ds_3.value) + parseFloat(
                            ds_4.value) +
                    ...
                    if ((parseInt(total_dist * 4)) > 1000) {
                        document.getElementById("error_monthDist").className =
                            "box2 sb12 pl-2 d-flex flex-row justify-content-center"
                    } else {
                        document.getElementById("error_monthDist").className =
                            "box2 sb12 pl-2 d-none flex-row justify-content-center"
                    }
                }
