...
class m_ToursTableSeeder extends Seeder
{
    ...
    \DB::table('m__tours')->insert(array (
       ...
       array (
              ...
              'title_abbreviation' => '京滋地区歴史探訪コース',
       ...
       //        'title_abbreviation' => 'ザ･日本のルーツコース',
